...
[![CI](https://github.com/sigmatactical-org/payments/actions/workflows/ci.yml/badge.svg)](https://github.com/sigmatactical-org/payments/actions/workflows/ci.yml)
...
```bash
cd sigma/it/payments && cargo run -p sigma-payments
```
